...
import team14 from "/assets/img/team/a.png"
import team15 from "/assets/img/team/b.png";
import team16 from "/assets/img/team/c.png";
import team17 from "/assets/img/team/d.png";
              ...
              <div className="col-lg-7 pl-80 pl-md-15 pl-xs-15">
                <div className="about-style-one-info">
                  <p>
                    ...
                    design and efficient code. I excel in front-end development,
                    with a deep understanding of HTML, CSS, JavaScript, and
                    various frameworks. My passion is turning ideas into
                    functional and aesthetically pleasing digital experiences.
                  </p>
                  <Link className="btn-style-regular btn-border" to="#">
                    <span>Learn More</span> <i className="fas fa-arrow-right" />
                  </Link>
                </div>
              </div>
            </div>
